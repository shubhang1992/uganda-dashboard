...
const TrendArrow = ({ trend }) => (
  <span className={styles.trendBadge} data-trend={trend}>
    {trend === 'up' && <svg viewBox="0 0 12 12" fill="none" width="10" height="10"><path d="M6 9V3M6 3L3 6M6 3l3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>}
    {trend === 'down' && <svg viewBox="0 0 12 12" fill="none" width="10" height="10"><path d="M6 3v6M6 9L3 6M6 9l3-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>}
    {trend === 'flat' && <svg viewBox="0 0 12 12" fill="none" width="10" height="10"><path d="M2 6h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg>}
  </span>
);
                ...
                <div className={styles.toolbar}>
                  ...
                  <div style={{ position: 'relative' }} ref={regionBtnRef}>
                    <button className={styles.filterBtn} data-active={!!regionFilter} onClick={() => setRegionDropOpen((p) => !p)}>
                      <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><path d="M2 4h12M4 8h8M6 12h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg>
                  ...
                  <div style={{ position: 'relative' }} ref={sortBtnRef}>
                    <button className={styles.filterBtn} data-active={sortKey !== 'subscribers'} onClick={() => setSortDropOpen((p) => !p)}>
                      <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><path d="M4 2v12M4 14l-3-3M4 14l3-3M12 14V2M12 2l-3 3M12 2l3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                      ...
                      filtered.map((agent, i) => {
                        ...
                        return (
                          <motion.button
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.2, delay: Math.min(i * 0.012, 0.3), ease: EASE_OUT_EXPO }}
                          >
